...
async function uploadToPomf(path) {
  try {
    ...
    console.log("Error at pomf uploader in all/uploader.js:", error)
    return "error"
  }
}
...
module.exports = { pinterest, remini, wallpaper, wikimedia, porno, hentai, quotesAnime, igstalk, aiovideodl, umma, ringtone, styletext, uploadToPomf, uploadToCdn, UploadFileUgu, kapital  }
